...
namespace YoutubeBlog.Data.Migrations
{
    ...
    [Migration("20240530135845_mig_first")]
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab1dae6a-5cf6-450e-a667-37a51a19abf8"),
                            ...
                            CreatedDate = new DateTime(2024, 5, 30, 16, 58, 45, 380, DateTimeKind.Local).AddTicks(4699),
                        ...
                        new
                        {
                            Id = new Guid("5a3b1151-55c9-49d2-8bb2-ef27ce37d1fb"),
                            CategoryId = new Guid("d23e4f79-9600-4b5e-b3e9-756cdcacd2b1"),
                            Content = "Visual Studio Sed porttitor lectus nibh...",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 30, 16, 58, 45, 380, DateTimeKind.Local).AddTicks(4706),
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 30, 16, 58, 45, 380, DateTimeKind.Local).AddTicks(5962),
                            IsDeleted = false,
                            Name = "ASP.NET Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 30, 16, 58, 45, 380, DateTimeKind.Local).AddTicks(5975),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("YoutubeBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 30, 16, 58, 45, 380, DateTimeKind.Local).AddTicks(6969),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 5, 30, 16, 58, 45, 380, DateTimeKind.Local).AddTicks(6972),
